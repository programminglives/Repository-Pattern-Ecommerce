    ...
    <nav class="navbar navbar-expand-sm navbar-default">
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="menu-title">Product and Categories</li><!-- /.menu-title -->
                ...
                <li class="menu-item-has-children dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <i class="menu-icon fa fa-table"></i>Categories
                    </a>
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-plus"></i><a href="{{ route('admin.categories.create') }}">Add New</a></li>
                        <li><i class="fa fa-bars"></i><a href="{{ route('admin.categories.index') }}">View All</a></li>
                    </ul>
                </li>

                <li class="menu-title">Website Settings</li><!-- /.menu-title -->
                <li class="menu-item-has-children dropdown">
